...
return [
    ...
    'mail_for_emergency' => array_values(array_filter(array_map('trim', explode(',', (string) env(
        'MAIL_FROM_ADDRESS_EMERGENCY',
        'michaela.l@bodypoint.com,hayleebash@bodypoint.com'
    ))))),
