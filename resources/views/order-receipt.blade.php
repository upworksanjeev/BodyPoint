      ...
      <tr>
        <td>
          <div style="padding: 24px;">
            <table style="width: 100%; border-collapse: collapse; border-spacing: 0px;">
              <tr>
                <td style="vertical-align: top; padding: 3px 5px;"><span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400; min-width: 55px;">Name:</span></td>
                <td style="vertical-align: top; padding: 3px 5px;"><span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">{{ $userDetail->shipping_user_name }} {{ $userDetail->shipping_last_name }}</span></td>
              </tr>
              <tr>
                <td style="vertical-align: top; padding: 3px 5px;"><span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400; min-width: 55px;">Address:</span></td>
                <td style="vertical-align: top; padding: 3px 5px;"><span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">{{ $userDetail->shipping_address }}, <br>{{ $userDetail->shipping_city }}, {{ $userDetail->shipping_state }} {{ $userDetail->shipping_zip }} {{ $userDetail->shipping_country }}</span></td>
              </tr>
              <tr>
                <td style="vertical-align: top; padding: 3px 5px;"><span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400; min-width: 55px;">Country:</span></td>
                <td style="vertical-align: top; padding: 3px 5px;"><span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">{{ $userDetail->shipping_country }}</span></td>
              </tr>
              <tr>
                <td style="vertical-align: top; padding: 3px 5px;"><span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400; min-width: 55px; ">Phone:</span></td>
                <td style="vertical-align: top; padding: 3px 5px;"><span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400; ">+1 {{ $userDetail->shipping_phone }}</span></td>
              </tr>
            </table>
          </div>
        </td>
