...
<body>
    ...
    <div
        ...
        <div style="padding: 24px;">
            ...
            <div style="display: flex; gap: 20px; align-items: center; margin-top: 20px;">
                <span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">Customer PO No:</span>
                <span
            ...
            <tr>
                <td>
                    <div style="background-color: #00838f; padding: 8px 24px">
                        <h4 style="color: #fff; font-size: 16px; font-weight: 400; line-height: 24px; margin: 0px;">Ship
                            to information</h4>
                    </div>
                </td>
                <td style="border-color: green;">
                    <div style="background-color: #00838f; padding: 8px 24px;">
                        <h4 style="color: #fff; font-size: 16px; font-weight: 400; line-height: 24px; margin: 0px;">Bill
                            to information</h4>
                    </div>
                </td>
            </tr>
        ...
        <div style="background-color: #00838f; padding: 8px 24px;">
            <h4 style="color: #fff; font-size: 16px; font-weight: 400; line-height: 24px; margin: 0px;">Payment Method
            </h4>
        </div>
        <div style="padding: 24px;">
            <span
        ...
        <div style="padding: 24px;">
            ...
            <div style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400; margin-top: 20px;">Carrier:
            </div>

            <div style="line-height: 19px; color: #6b7280; font-size: 13px; font-weight: 400; margin-top: 20px;">All
                orders placed will ship within 5 business days. Freight cost is calculated at time of shipping. For
                expedited shipping options please contact customer service at Sales@bodypoint.com or 206.405.4555.</div>
                ...
                border-collapse: collapse; border-spacing: 0px;">
                            <tr>
                                <td>
                                    ...
                                    <div style="font-size: 14px; font-weight: 400; color: #000; line-height: 24px;">Sub
                                        Total: </div>
                                    <div style="font-size: 14px; font-weight: 400; color: #000; line-height: 24px;">Tax:
                                    </div>
