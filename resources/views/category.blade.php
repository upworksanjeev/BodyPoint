...
<section class="py-3">
	...
	<?php if(isset($error)){ echo $error; }else{ ?>
		<div class="ctm-prd-one relative overflow-hidden py-[30px] lg:py-[50px] px-[20px] lg:px-[70px] bg-no-repeat bg-center bg-cover h-[200px] md:h-[400px] flex justify-center rounded-[20px] after:content-['*'] after:absolute after:top-0 after:bottom-0 after:left-0 after:right-0 after:bg-[#000]/[.5] after:w-full after:h-full" style="background-image: url('<?php echo url('storage/' . $category['image']); ?>')">
