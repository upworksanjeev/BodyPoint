    ...
    <div style="margin-bottom:50px;">
        <div style="border: 1px solid rgba(23, 23, 23, 0.1); background-color: #fff;  box-shadow: 0px 0px 4px #e5e7eb; border-radius: 16px; max-width: 920px; margin: 0px auto">
            <div style="background-color: #00838f; padding: 8px 24px; border-radius: 16px 16px 0px 0px;">
                <h4 style="color: #fff; font-size: 16px; font-weight: 400; line-height: 24px; margin: 0px;font-family: 'Avenir LT', Sans-serif; ">Quote Information</h4>
            </div>
            <div style="padding: 24px;">
                ...
                <div style="display: flex; gap: 20px; align-items: center; margin-top: 20px;">
                    ...
                    <span style="background-color: #31ba32; font-size: 14px; font-weight: 500; line-height: 20px; padding: 2px 20px; border-radius: 100px; color: #fff;">{{ $quote->purchase_order_no }}</span>
                </div>
                <div style="display: flex; gap: 20px; align-items: center; margin-top: 20px;">
                    <span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">Order Date:</span>
                    <span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">{{ date('F j, Y',strtotime($quote->created_at)) }}</span>
                </div>
                <div style="display: flex; gap: 20px; align-items: center; margin-top: 20px;">
                        ...
                        <div style="padding: 24px;">
                            <table style="width: 100%;  border-collapse: collapse; border-spacing: 0px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">{{ session('customer_details')['billAddressLine2']??''  }} <br>{{ session('customer_details')['billAddressLine4'] ??'' }} {{ session('customer_details')['billAddressLine1'] ??'' }} {{ session('customer_details')['billAddressPostalCode'] ??''  }} {{ session('customer_details')['billAddressLine5'] ??'' }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: top; padding: 3px 5px;">
