                        ...
                        <div class="flex flex-wrap	">
                            ...
                            <div class="w-full md:w-2/4 pr-0 md:pr-2 mt-4">
                                ...
                                <x-text-input id="primary_phone" class="block mt-1 w-full"
                                                type="number"
                                                name="primary_phone"  :value="old('primary_phone' , str_replace('-','',$userDetail->primary_phone))"  autofocus autocomplete="primary_phone" />
                            ...
                            <div class="w-full md:w-2/4  pl-0 md:pl-2 mt-4">
                                ...
                                <x-text-input id="alternate_phone" class="block mt-1 w-full"
                                                type="number"
                                                name="alternate_phone" :value="old('alternate_phone' , str_replace('-','',$userDetail->alternate_phone))"  autofocus autocomplete="alternate_phone"/>
