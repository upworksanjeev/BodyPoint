...
<body>
                ...
                <td style="vertical-align: top;width:50%;">
                    <div style="display: flex; gap: 20px; align-items: center;">
                        <span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">Quote
                            No.:</span>
                        <span
                            style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">{{ $cart[0]->purchase_order_no ?? '' }}</span>
                    </div>
                ...
                <td style="width: 50%;padding: 15px;">
                    <table style="width: 100%; border-collapse: collapse; border-spacing: 0px; ver">
                        ...
                        <tr>
                            ...
                            <td><span style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;">
                    ...
                    <table style="width: 100%;  border-collapse: collapse; border-spacing: 0px;vertical-align: top;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span
                                    style="line-height: 17px; color: #000; font-size: 14px; font-weight: 400;vertical-align: top;">
    ...
    <div style="padding: 0px;">
        ...
        @if ($priceOption == 'msrp_only')
            ...
            <div
                style="font-size: 11px;font-weight: 400;color: #000;line-height: 1.35;border: 1px solid #ccc;padding: 6px 15px;border-radius: 10px;
margin-bottom: 8px;">
