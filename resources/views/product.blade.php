<x-mainpage-layout>
        ...
        <div class="ctm-container py-[30px] md:py-[60px]">
            <div class="chest-support">
                <div class="chest-img">
                    ...
                    <iframe src="{{ $product['video'] ?? '' }}" class="w-full aspect-video rounded-lg"
                        height="280"></iframe>
    ...
    <section class="py-[30px] md:py-[60px]">
        <div class="max-w-screen-xl mx-auto ctm-accordion xl:px-0 lg:px-8 md:px-6 px-4">
            <div class="accordion">
                <div class="accordion-item border border-solid border-[#e5e6e7]">
                    <div class="accordion-item-header items-center bg-transparent">
                        <span class="w-[28px] h-[28px] mr-3">
