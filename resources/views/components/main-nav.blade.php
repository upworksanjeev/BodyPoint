     ...
     <div class="ctm-pt relative flex flex-wrap items-center justify-between pb-[10px]">
         ...
         <div
             ...
             <div class="flex flex-shrink-0 items-center">
                 <a href="{{ config('bodypoint.home_url') }}" class="site-logo"> <img class="h-14 w-auto"
                         src="{{ asset('img/logo-1.png') }}" alt="Body Point" /> </a>
             </div>
             <div class="hidden sm:ml-6 lg:block">
                 <div class="flex items-center space-x-4 nav-links mr-5 ">
         ...
         <div
             class="hidden flex items-center pr-2 sm:static sm:inset-auto sm:pr-0 w-full lg:w-2/12 xl:w-2/12 lg:block searchBar">
