...
/**
 * The Partner Vault catalogue as it lives today: nested PHP arrays in the
 * historical HomeController. Kept here as the seed source so we import once
 * into vault_assets and stop editing controller code to add a file.
 *
 * After the first seed, marketing maintains records in Nova. Re-running the
 * seeder upserts by file URL and will not wipe tags or shelf flags that have
 * been edited since.
 */
class LegacyVaultCatalog
{
    public function frequentlyUsed(): array
    {
        return
            [
                [
    ...
    public function newlyAdded(): array
    {
        return
            [
                [
    ...
    public function pricingGuide(): array
    {
        return
            [
                [
    ...
    public function productAndTechnical(): array
    {
        return
            [
    ...
    public function marketingCollateral(): array
    {
        return
            [
